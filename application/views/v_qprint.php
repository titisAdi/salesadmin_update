...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url()."assets/bootstrap/"?>css/font-awesome/css/font-awesome.min.css">
	...
	<div class="wrapper" id="testcase" style="padding-top: 0mm; padding-right: 10mm; padding-bottom: 10mm; padding-left: 10mm;">
			...
			<div class="row invoice-info">
          	...
          	<div class="row">
				...
				<div class="col-xs-12">
            		<table class="table table-striped" width="100%"  height="25%">
                		...
                		<thead class="bg-aqua-active color-palette" height="25%">
                			<tr>
                				<th colspan="6">Subtotal</th>
				  				<th style="width:15%"><?php echo number_format($subtotal1,'2',',','.') ?></th>
                			</tr>
                		</thead>
                		<thead class="bg-aqua-active color-palette">
                			<tr>
                				<th colspan="6">Discount</th>
                				<th style="width:15%"><?php echo number_format($discount,'2',',','.') ?></th>
                			</tr>
                			<tr>
                				<th colspan="6">After Discount</th>
                				<th style="width:15%"><?php echo number_format($subtotal2,'2',',','.') ?></th>
                			</tr>
                			<tr>
                				<th colspan="6">PPn</th>
				  				<th style="width:15%"><?php echo number_format($ppn,'2',',','.') ?></th>
                			</tr>
                			<tr>
                  				<th colspan="6">Total</th>
				  				<th style="width:15%"><?php $total=$ppn+$subtotal2;
...
<script src="<?php echo base_url()."assets/bootstrap/"?>js/app.js"></script>
</body>
</html>