		...
		<div class="container-fluid">
			<div class="panel">
				<div class="panel-heading">
					<h3 class="panel-title">Proposal Revision</h3>
						<p class="panel-subtitle">
							<ol class="breadcrumb">
		                            ...
		                            <li class="active">
		                                <i class="fa fa-edit"></i> Proposal Revision
		                            </li>
		                        </ol>
	                    </p>
				</div>
				<div class="panel">
					...
					<form name="proposal" action="<?php echo base_url()."index.php/SalesAdmin/cproposal_process"; ?>" method="post">
						<div class="form-group">
							<label>Proposal ID &amp; Revision </label>
							<input type="type" class="form-control" id="lead" name="lead" value="<?php echo $idproposal.$rev?>" readonly>
						</div>
                    	<div class="form-group">
							<label>Follow up date : </label>
							<input type="date" class="form-control" id="datepick" name="date" value="<?php echo $date?>">
						</div>
						<br>
						<div class="form-group">
								...
								<table class="table table-striped" id="tablelic">
									...
									<tr>
										...
										<td>
											...
											<?php $hitung = $price-$discount?>
												<option value=""><?php echo $productcode?> || <?php echo $productname?> || <?php echo $employeelimit?> || <?php echo $hitung?></option>
					...
					<div class="panel-body">
						<table class="table table-striped" id="tablewd">
				            ...
				            <?php $wd=0 ?>
				              	...
				              	<td><input type="Text" class="form-control" name="wddesc[]" maxlength="100" value="<?php echo $description?>"></td>
				              	<td><input type="text" name="wdquantity[]" id="quantity_<?php echo $wd; ?>" class="form-control totalLineWD changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $qty?>"></td>
				                <td><input type="text" name="wdrate[]" id="price_<?php echo $wd; ?>" class="form-control changesNo" autocomplete="off" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" value="<?php echo $rate?>"></td>
